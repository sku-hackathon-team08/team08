...
사용자 요청으로 [PRD v1.2 기반 API 검토안](api/festival.md)을 작성했습니다. 경로·모델·권한·실패·재전송·지원 수명을 구체화했으며 기획 의존 미정은 [결정 목록](api/festival.md#review)에 연결합니다. API 채택·구현 완료 기록이 아니며 ERD는 변경하지 않습니다.
