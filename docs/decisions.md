...
| D-033 | 2026-09-08 | [DB 연결·세션](guides/backend.md#db-연결과-세션-수명)에 SQLAlchemy asyncio·aiosqlite·psycopg 사용 | #35 구현. SQLite 파일 생성·기존 데이터 유지, PostgreSQL 선택 시 실제 연결, 제한 시간·FK·수명 정리와 두 DB의 CI 검증 구성. 업무 모델·마이그레이션·commit 계층은 후속 결정 |
