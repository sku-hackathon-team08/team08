...
> PRD v1.2 · 2026-09-10. 사용자 흐름·권한·인수 조건을 관리합니다. 각 문서의 미정·검토안은 확정 정책과 구분합니다. 현재 기술 계약은 [해커톤 API](../api/hackathon.md)·[DB 저장](../db/storage.md)에서 관리합니다.

| 문서 | 범위 |
|---|---|
| [행사 진입](event-entry.md) | 준비된 행사 코드 진입·역할 선택·세션 유지 |
